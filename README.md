...
-  Syntax logging yang ada di **MALANG** dan **MOJOKERTO**:
   ...
   **Penjelasan dari syntax logging di MALANG dan MOJOKERTO**:
   - ```iptables -N LOGGING```: membuat chain baru bernama **LOGGING**
